	...
	<header class="entry-header">
		...
		elseif(get_queried_object_id() == 25) : ///// for loop page 
										...
										<div class="loop_date_div">
											<p class="loop_post_date">  
												<?php echo get_the_date( 'j' ); ?> 
											</p>
											<p class="loop_post_date_month">  
												<?php echo get_the_date( 'M' ); ?> 
											</p>
										</div>
										<?php
										the_title( '<div class="loop_title_div"><h1><a class="loop_post_title" href="' . esc_url( get_permalink() ) . '" rel="bookmark">', '</a></h1></div>' );
										?>
										</div>
